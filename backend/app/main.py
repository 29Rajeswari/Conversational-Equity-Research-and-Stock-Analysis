...
from app.api import chat, research, financial, news, health, search, market, unified_search, ws_stream
from app.auth.auth_router import router as auth_router 
from app.market_data.providers import TwelveDataProvider
from app.startup_market import init_market_services
...
app.include_router(unified_search.router, prefix="/api", tags=["unified_search"])
